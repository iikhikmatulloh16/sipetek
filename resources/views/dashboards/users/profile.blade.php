                ...
                <div class="col-xl-4 col-lg-5">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="javascript:void(0)" class="btn btn-success btn-sm mb-2" id="change_picture_btn"><i class="mdi mdi-file-image-plus-outline"></i> Change Picture</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                ...
                                <li class="nav-item"><a href="#pengaduan" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0"> Pengaduan </a></li>
                            </ul>
                            <!-- Tab Content -->
                            <div class="tab-content">
                                <!-- About Me -->
                                <div class="tab-pane active" id="aboutme">
                                    <form action="{{ route('userUpdateInfo') }}" method="POST" id="UserInfoForm" autocomplete="off">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control text-capitalize" name="name" id="name" value="{{ Auth::user()->name }}" placeholder="Masukkan nama kamu" required readonly/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="{{ Auth::user()->tempat_lahir }}" placeholder="Masukkan tempat lahir" required/>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form action="{{ route('userChangePassword') }}" method="POST" id="changePasswordUserForm">
                                ...
                                {{-- tab-pane Pengaduan Start --}}
                                <div class="tab-pane" id="pengaduan">
                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-bullhorn me-1"></i> PENGADUAN</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <a href="{{ url('pengaduans/create') }}" class="btn btn-success btn-block"><i class="mdi mdi-plus"></i> Tambah Pengaduan</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <a href="{{ url('pengaduans') }}" class="btn btn-primary btn-block"><i class="mdi mdi-eye"></i> Lihat Pengaduan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                {{-- tab-pane Pengaduan End --}}
                            </div>
                            <!-- End Tab Content -->
                        </div>
                        <!-- End Card Body -->
                ...
                success:function(data){
                    if (data.status == 0) {
                        ...
                        $('.user_nik').each(function(){
                            $(this).html( $('#UserInfoForm').find($('input[name="nik"]')).val() );
                        });
                        ...
                        $('.user_tempat_lahir').each(function(){
                            $(this).html( $('#UserInfoForm').find($('input[name="tempat_lahir"]')).val() );
                        });
                        $('.user_tanggal_lahir').each(function(){
                            $(this).html( $('#UserInfoForm').find($('input[name="tanggal_lahir"]')).val() );
                        });
                        $('.user_status_perkawinan').each(function(){
                            $(this).html( $('#UserInfoForm').find($('select[name="status_perkawinan"]')).val() );
                        });
                        $('.user_jenis_kelamin').each(function(){
                            $(this).html( $('#UserInfoForm').find($('select[name="jenis_kelamin"]')).val() );
                        });
                        $('.user_email').each(function(){
                            $(this).html( $('#UserInfoForm').find($('input[name="email"]')).val() );
                        });
                        $('.user_phone').each(function(){
                            $(this).html( $('#UserInfoForm').find($('input[name="phone"]')).val() );
                        });
                        alert(data.msg);
                    }
                }
