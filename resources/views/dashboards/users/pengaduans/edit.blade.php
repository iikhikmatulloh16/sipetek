                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('pengaduans') }}" class="btn btn-primary mb-3"><i class="mdi mdi-arrow-left"></i> Back</a>
                            <!-- Tab Content -->
                            <div class="tab-content">
                                <form action="pengaduans/{{ $pengaduan->slug }}" method="POST" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('subjek') is-invalid @enderror" name="subjek" id="subjek" placeholder="Masukkan subjek" value="{{ old('subjek', $pengaduan->subjek) }}" required autofocus/>
                                                @error('subjek')
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-success mt-2"><i class="mdi mdi-content-save"></i> Simpan Perubahan</button>
                                    </div>
                                </form>
                            </div>
                            <!-- End Tab Content -->
