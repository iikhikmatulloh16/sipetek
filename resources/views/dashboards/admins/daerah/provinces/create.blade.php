...
@endsection
@section('title', 'Tambah Provinsi | SI Pengaduan Tenaga Kerja')
...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            {{-- Card Body Start --}}
            <div class="card-body">
                <h4 class="header-title">Form Tambah Provinsi</h4>
                <p class="text-muted font-14 mb-3">Lorem, ipsum dolor sit amet <code>&lt;consectetur&gt;</code> adipisicing elit. Voluptate, accusamus!</p>

                <form action="admin/provinces" method="POST" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="id" class="form-label">ID Provinsi</label>
                                <input type="text" class="form-control @error('id') is-invalid @enderror" name="id" id="id" placeholder="Masukkan id provinsi" value="{{ old('id') }}" required autofocus>
                                @error('id')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Masukkan nama provinsi" value="{{ old('name') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-success mt-2"><i class="mdi mdi-view-grid-plus me-1"></i> Tambah Provinsi</button>
                    </div>
                </form>
            </div>
            {{-- Card Body End --}}
