...
@endsection
@section('title', 'Tambah Kecamatan | SI Pengaduan Tenaga Kerja')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="admin/districts" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('id') is-invalid @enderror" name="id" id="id" placeholder="Masukkan id kecamatan" value="{{ old('id') }}" required autofocus>
                                @error('id')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Masukkan nama kecamatan" value="{{ old('name') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-success mt-2"><i class="mdi mdi-view-grid-plus me-1"></i> Tambah Kecamatan</button>
                    </div>
                </form>
            </div>
            {{-- Card Body End --}}
