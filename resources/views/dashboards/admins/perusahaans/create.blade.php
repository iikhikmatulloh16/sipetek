...
@endsection
@section('title', 'Tambah Perusahaan | SI Pengaduan Tenaga Kerja')
...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            {{-- Card Body Start --}}
            <div class="card-body">
                <form action="admin/perusahaans" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Masukkan nama kabupaten" value="{{ old('name') }}" required autofocus>
                                @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cabangdalam') is-invalid @enderror" name="cabangdalam" id="cabangdalam" placeholder="Masukkan jumlah cabang di indonesia" value="{{ old('cabangdalam') }}" required>
                                @error('cabangdalam')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cabangluar') is-invalid @enderror" name="cabangluar" id="cabangluar" placeholder="Masukkan jumlah cabang di luar negeri" value="{{ old('cabangluar') }}" required>
                                @error('cabangluar')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="province_id" id="select_province" data-placeholder="Select" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="regency_id" class="form-label">Pilih Kabupaten</label>
                                <select class="form-select" name="regency_id" id="select_regency" data-placeholder="Select" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="district_id" id="select_district" data-placeholder="Select" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="village_id" class="form-label">Pilih Kelurahan</label>
                                <select class="form-select" name="village_id" id="select_village" data-placeholder="Select" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pos') is-invalid @enderror" name="pos" id="pos" placeholder="Masukkan kode pos" value="{{ old('pos') }}" required>
                                @error('pos')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="4" placeholder="Write something..." required></textarea>
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="Masukkan telpon perusahaan" value="{{ old('phone') }}" required>
                                @error('phone')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Masukkan email perusahaan" value="{{ old('email') }}" required>
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-success mt-2"><i class="mdi mdi-view-grid-plus me-1"></i> Tambah Perusahaan</button>
                    </div>
                </form>
                {{-- Tab Content End --}}
            </div>
